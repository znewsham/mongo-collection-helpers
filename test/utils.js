...
import { combineProjections, unionOfProjections, isProjectionExclusion } from "../lib/index.js";
...
describe("unionOfProjections", () => {
  ...
  it("Should work with partial projections of arrays using $elemMatch", () => {
    assert.deepEqual(
      unionOfProjections([
        {
          a: 1
  ...
  it("Should work with partial projections of arrays using $elemMatch (other way)", () => {
    assert.deepEqual(
      unionOfProjections([
        {
          a: {
  ...
  it("Should work with partial projections of arrays using $slice", () => {
    assert.deepEqual(
      unionOfProjections([
        {
          a: 1
  ...
  it("Should work with partial projections of arrays using $slice (other way)", () => {
    assert.deepEqual(
      unionOfProjections([
        {
          a: {
  ...
  it("Should work with multiple partial projections of arrays using $elemMatch", () => {
    assert.deepEqual(
      unionOfProjections([
        {
          a: {
  ...
  it("Should work with multiple partial projections of arrays using $slice", () => {
    assert.deepEqual(
      unionOfProjections([
        {
          a: {
